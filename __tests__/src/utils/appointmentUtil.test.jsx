...
describe('Appointment Util', () => {
    ...
    test("validate data", () => {
        ...
        const expectPurposes = [{"id":"Clinical_Diagnosis","title":"Clinical_Diagnosis","subtitle":"Vision"},{"id":"NO_APPOINTMENT","title":"NO APPOINTMENT","subtitle":"Medical"},{"id":"Comprehensive","title":"Comprehensive","subtitle":"Medical"},{"id":"Glaucome_Appointment","title":"Glaucoma_Appointment","subtitle":"Vision"},{"id":"Retina_checkup","title":"Retina checkup","subtitle":"Vision"}]
