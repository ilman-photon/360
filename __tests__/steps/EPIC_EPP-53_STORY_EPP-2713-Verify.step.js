...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-53_STORY_EPP-2713- Verify whether the user is able to lands on Dashboard/ Prescription screen", ({
    given,
    when,
    and,
  }) => {
  ...
  test("EPIC_EPP-53_STORY_EPP-2713- Verify whether the user is able to clicks on the link", ({
    given,
    when,
    and,
    then,
    ...
    and(
      "user should be able to view a link and able to clicks on the link",
      () => {
  ...
  test("EPIC_EPP-53_STORY_EPP-2713- Verify whether the user will redirect to an e-commerce site in a new tab", ({
    given,
    when,
    and,
    then,
    ...
    and(
      "user should get redirected to the user to an e-commerce site in a new tab",
      () => {
