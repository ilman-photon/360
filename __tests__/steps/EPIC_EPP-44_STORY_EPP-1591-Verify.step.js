...
defineFeature(feature, (test) => {
  ...
  function createMatchMedia(width) {
    ...
    test('EPIC_EPP-44_STORY_EPP-1591 -Verify if user able to view system date by default set as todays date', ({ given, when, and, then }) => {
        let container
    ...
    test('EPIC_EPP-44_STORY_EPP-1591 -Verify if user able to change the date of appointment', ({ given, when, and, then }) => {
        let container
        given('user launch the Patient Portal URL', () => {
            defaultValidation()
        });
