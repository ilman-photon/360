...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-23_STORY_EPP-6148- Verify if the user able to clicks the download option", ({
    given,
    when,
    and,
    then,
    ...
    and(
      "user should see and click  the option to download the attachment",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-23_STORY_EPP-6148- Verify if able to see attachement downloaded in the device", ({
    given,
    when,
    and,
    then,
