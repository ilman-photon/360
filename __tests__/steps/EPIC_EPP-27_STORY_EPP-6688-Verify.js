...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint8/EPP-6688.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-27_STORY_EPP-6688 - Verify whether the user is able to navigate the Dashboard page", ({
    given,
    when,
    and,
  }) => {
  ...
  test("EPIC_EPP-27_STORY_EPP-6688 - Verify whether the User views the ‘Education Materials' sub-menu under the ‘Documents’ menu", ({
    given,
    when,
    and,
    then,
  ...
  test("EPIC_EPP-27_STORY_EPP-6688 - Verify whether the User is able to view the list of education materials", ({
    given,
    when,
    and,
    then,
    ...
    then("user is able to view the list of education materials", () => {
      const titleEdu = container.getByText(/Guide To Macular Degeneration Surgery/i);
      expect(titleEdu).toBeInTheDocument();
    });
  });
});
