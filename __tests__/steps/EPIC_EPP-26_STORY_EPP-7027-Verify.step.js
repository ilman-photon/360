...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint8/EPP-7027.feature",
  {
...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-26_STORY_EPP-7027 - Negative Test Cases-Verify user should see the error message when the service is unavailable - when User clicks on the option to download the medical record', ({ given, and, when, then }) => {
  ...
  test('EPIC_EPP-26_STORY_EPP-7027 - Negative Test Cases-Verify user should see the error message when the internet service is unavailable - when User clicks on the option to download the medical record', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7027 - Verify User should be able to download the medical record as PDF file', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
