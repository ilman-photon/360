...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1573 - Verify user able to provide the details to schedule the appointment as a guest and user not providing the purpose of visit.", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1573 - Verify user able to provide the details to schedule the appointment as a guest and the user not providing the insurance name.", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1573 - Verify user able to provide the details to schedule the appointment as a guest and user not providing the purpose of visit and insurance name.", ({
    given,
    and,
    then,
  }) => {
