...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the option to schedule appointments', ({ given, when, then, and }) => {
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should navigated to the "View Schedule Appointment" screen when user selects the option of schedule appointments', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the widget with upcoming appointments', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should navigated to "upcoming test/ procedure" screen when user clicks the widget with upcoming test/ procedure', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the widget with latest prescriptions', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should navigated to "latest prescriptions" screen when user clicks the widget with latest prescriptions', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
  ...
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the following verbiage "There are no upcoming test and procedures." in the upcoming test/ procedures widget when there are no appointments', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
	...
	and(/^User should see the following verbiage "(.*)" in the upcoming test and procedures widget when there are no appointments$/, (arg0) => {
		defaultValidation();
	});
  })
  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the following verbiage "There are no prescriptions." in the upcoming latest prescriptions when there are no appointments', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
	...
	and(/^User should see the following verbiage "(.*)" in the upcoming latest prescriptions when there are no appointments$/, (arg0) => {
		defaultValidation();
	});
  })

  test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should navigated to "upcoming appointment" screen when user clicks the widget with upcoming appointment', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
...
test('EPIC_EPP-1_STORY_EPP-2715 - Verify User should see the widget with upcoming test/ procedures', ({ given, when, then, and }) => {
	given('User launch Patient Portal url', () => {
		defaultValidation();
	});
