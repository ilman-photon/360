...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-16_STORY_EPP-2701- Verify whether the user is able to lands on the screen to view Care Plan Overview', ({ given, when, and, then }) => {
  ...
  test('EPIC_EPP-16_STORY_EPP-2701- Verify whether the user is able to view the mentioned details', ({ given, when, and, then }) => {
    given('user Launch  the browser and enter the user portal URL', () => {
        launchBrowser();
    });
  ...
  test('EPIC_EPP-16_STORY_EPP-2701- Verify whether the user is  able to see an option to download the care plan overview document (as pdf) which when clicked downloads the document', ({ given, when, and, then }) => {
    given('user Launch  the browser and enter the user portal URL', () => {
        launchBrowser();
    });
    ...
    and('user should be able to see an option to download the care plan overview document (as pdf) which when clicked downloads the document', async () => {
        userSeeMoreIcon();
    });
});

  test('EPIC_EPP-16_STORY_EPP-2701- Verify whether the user is able to view the following verbiage “There is no care plan overview document.” when there is no care plan overview documents for the user', ({ given, when, and, then }) => {
    given('user Launch  the browser and enter the user portal URL', () => {
        launchBrowser();
    });
