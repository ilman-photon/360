...
defineFeature(feature, (test) => {
  ...
  container = render(<Provider store={store}>{ScheduleAppointmentPage.getLayout(<ScheduleAppointmentPage />)}</Provider>);
  ...
  test('EPIC_EPP-44_STORY_EPP-1563 - Verify user able to provide the basic details when scheduling appointment for someone else.', ({ given, then, and }) => {
    ...
    then('user should see Schedule Appointment screen with the selected location, date, purpose of visit and insurance carrier', async () => {
