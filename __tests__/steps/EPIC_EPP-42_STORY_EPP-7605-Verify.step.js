...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint9/EPP-7605.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-42_STORY_EPP-7605- Verify User should receive an email message with the following content (ECP to provide content)", ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-42_STORY_EPP-7605- Verify User should receive a text message with the following content (ECP to provide content)", ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-42_STORY_EPP-7605- Verify User should see the message “<Health Record/ Prescription/ Care plan document> is shared successfully.” when the items has been shared", ({}) => {});
  test("EPIC_EPP-42_STORY_EPP-7605-Negative Test Cases-Verify user should see the error message when the internet service is unavailable - when User enters the required details and clicks on the option to share", ({
    given,
    when,
    then,
    and,
