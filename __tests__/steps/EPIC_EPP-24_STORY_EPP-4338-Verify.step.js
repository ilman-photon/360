...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint8/EPP-4338.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-24_STORY_EPP-4338 - Verify User should be view doctor's details screen", ({
    given,
    and,
    when,
    then,
  ...
  test("EPIC_EPP-24_STORY_EPP-4338 - Verify User should be view doctor's details screen with following details", ({
    given,
    and,
    when,
    then,
    ...
    and("user should be view doctor's details screen", (table) => {
      defaultValidation();
    });
  });

  test("EPIC_EPP-24_STORY_EPP-4338 - Verify User should be able to view new tab is open with locations of doctor", ({
    given,
    and,
    when,
    then,
    ...
    then(
      "user should be able to view new tab is open with locations of doctor",
      () => {
        defaultValidation();
      }
    );
