...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the Prescription type is displaying correctly in the Glass prescription.', ({ given, when, and, then }) => {
  ...
  test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the Prescribed on is displaying the Prescribed date correctly in the Glass prescription.', ({ given, when, and, then }) => {
    given('Patient Launch  the browser and enter the Patient portal URL', () => {
        defaultValidation()
    });
...
test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the Expiry date is displaying  correctly in the Glass prescription.', ({ given, when, and, then }) => {
    given('Patient Launch  the browser and enter the Patient portal URL', () => {
        defaultValidation()
    });
...
test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the Doctor\'s name is displaying  correctly in the Prescribed by.', ({ given, when, and, then }) => {
    given('Patient Launch  the browser and enter the Patient portal URL', () => {
        defaultValidation()
    });
...
test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the below mentioned details are displaying in the each Prescription under Glass prescription', ({ given, when, and, then }) => {
    given('Patient Launch  the browser and enter the Patient portal URL', () => {
        defaultValidation()
    });
...
test('EPIC_EPP-17_STORY_EPP-2703 - To verify whether the below mentioned details are displaying in the each Prescription under Glass prescription View', ({ given, when, and, then }) => {
  given('Patient Launch  the browser and enter the Patient portal URL', () => {
    defaultValidation()
  });
