...
const feature = loadFeature(
  "./__tests__/features/Patient Portal/Sprint2/EPP-239.feature"
);
...
defineFeature(feature, (test) => {
  test("EPIC_EPP-7_STORY_EPP-239 - Verify user should see the \"Passwords do not match\" error message", ({
    ...
    and(
        "user should see \"Email or Phone Number\" field",
        () => {
          expect(true).toBeTruthy()
        }
    );
    ...
    and(
        "user should enter valid \"Email or Phone Number\" field",
        () => {
          expect(true).toBeTruthy()
        }
    );
    ...
    then(/^user should see "(.*)" screen$/, (arg0) => {
          container = render(<SetPasswordComponent
    ...
    then("User should see error message \"Passwords do not match\"",
        () => {
            ...
            fireEvent.click(continueId);
            setTimeout(() => {
                const usernameFieldError = container.getByLabelText(/errorUsernameNotFound/i)
