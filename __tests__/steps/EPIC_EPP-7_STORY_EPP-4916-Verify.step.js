...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-7_STORY_EPP-4916- Verify if the user enters a first-time wrong answer for a security question then the user account gets locked", ({
    ...
    then("Password Recovery Security Questions page is opened", () => {
      expect(
        container.getByText("Password recovery security questions page")
      ).toBeInTheDocument();
    });
  ...
  test("EPIC_EPP-7_STORY_EPP-4916- Verify if the user enters a 4th-time wrong answer for a security question then the user  sees the error message account gets locked", ({
    given,
    and,
    then,
    when,
  ...
  test("EPIC_EPP-7_STORY_EPP-4916- Verify if the user tries to log in to the patient portal after the account locked", ({
    given,
    and,
    then,
    when,
  ...
  test("EPIC_EPP-7_STORY_EPP-4916- Verify if the user receives an email link after the account gets locked", ({
    given,
    and,
    then,
    when,
  ...
  test("EPIC_EPP-7_STORY_EPP-4916- Verify if the user enters a 4th-time correct answer for a security question then check user account gets locked or not.", ({
    given,
    and,
    then,
    when,
    ...
    and(
      /^Enter the (\d+) time wrong answers to the security question$/,
      (arg0) => {
        const question1 = container.getByLabelText("Test Question 1 *");
        const question2 = container.getByLabelText("Test Question 2 *");
        const question3 = container.getByLabelText("Test Question 3 *");
    ...
    then("the user sees update  password page", async () => {
      ...
      mock
        .onPost(`/ecp/patient/securityquestions/validate`)
        .reply(200, success);
      const continueButton = container.getByTestId("continuebtn");
      fireEvent.submit(continueButton);
    });
