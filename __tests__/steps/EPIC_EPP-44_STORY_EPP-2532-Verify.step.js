...
defineFeature(feature, (test) => {
  ...
  const mock = new MockAdapter(axios);
  afterEach(cleanup);
  test("EPIC_EPP-44_STORY_EPP-2532- Verify if the user able to see the below mentioned functionality on Schedule appointment page.", ({
    given,
    when,
    and,
    then,
    ...
    and(
      "the user should see the search location, date of appointment, Purpose of the visit, Insurance Carrier",
      async () => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the error message This field is required is displaying when Date of Appointment is not filled.", ({
    given,
    when,
    and,
    then,
    ...
    when(
      "the user without selecting the Date of Appointment, click the search button.",
      async () => {
        const searchBtn = await waitFor(() =>
          container.getByTestId("searchbtn")
        );
    ...
    then(
      "user should see the error message This field is required for Date of Appointment field.",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-2532- Verify whether the system is automatically taking the current location if enabled.", ({
    given,
    when,
    and,
    then,
  ...
  test("EPIC_EPP-44_STORY_EPP-2532- Verify whether the user is able to search the location using City", ({
    given,
    when,
    and,
    then,
  ...
  test("EEPIC_EPP-44_STORY_EPP-2532-Verify whether the user is able to search the location using State", ({
    given,
    when,
    and,
    then,
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the user is able to search the location using Zipcode", ({
    given,
    when,
    and,
    then,
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the user is having the option to detect their location.", ({
    given,
    when,
    and,
    then,
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the list of Purpose of visit options are displaying.", ({
    given,
    when,
    and,
    then,
    ...
    then(
      "the user should see the List of options in the Purpose of visit dropdown",
      () => {
        const pusposeField = container.getByText(/Purpose of Visit/i);
        expect(pusposeField).toBeInTheDocument();
      }
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the list of Insurance Carrier options are displaying.", ({
    given,
    when,
    and,
    then,
    ...
    then(
      "user should see the List of options in the Insurance carrier.",
      () => {
        const insuranceField = container.getByText(/Insurance Carrier/i);
        expect(insuranceField).toBeInTheDocument();
      }
  ...
  test("EPIC_EPP-44_STORY_EPP-2532-Verify whether the 'Search' button is searching and displaying the result.", ({
    given,
    when,
    and,
    then,
