...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint8/EPP-4336.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-24_STORY_EPP-4336 - Verify User searches and selects a ECP Practise location to filter the doctors", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user click on one of ECP Practise location from the list",
      async () => {
    ...
    then(
      "user should be able to view list of doctor from the selected ECP Practise location",
      () => {
        expect(container.getByText(/Robert Fox/i)).toBeInTheDocument();
      }
    );
  ...
  test("EPIC_EPP-24_STORY_EPP-4336 - Verify User able to view filter result from ECP Practise location that they selected", ({
    given,
    and,
    when,
    then,
  ...
  test("EPIC_EPP-24_STORY_EPP-4336 - Verify User able to view filter button to open overlay", ({
    given,
    and,
    when,
    then,
