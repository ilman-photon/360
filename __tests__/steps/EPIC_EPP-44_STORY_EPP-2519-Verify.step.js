...
const resultsScreen = async () => {
  ...
  expect(
    await waitFor(() =>
      containerFilter.getByTestId(APPOINTMENT_TEST_ID.FILTER_RESULT.container)
    )
  ).toBeInTheDocument();
};
...
const reviewAppPage = async () => {
  let containerReview;
  containerReview = render(
    <Provider store={store}>
      {ScheduleAppointmentPage.getLayout(<ScheduleAppointmentPage />)}
    </Provider>
  );
  await waitFor(() => containerReview.getByText("Review Appointment Details"));
  containerReview = null;
};

const clickHour = async (container) => {
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify user able to search for location and select the date of appointment as well as purpose of visit and insurance.", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify user able to search for location and select the date of appointment as well as purpose of visit and insurance and user view the location", ({
    given,
    and,
    then,
  }) => {
    ...
    and("user views the selected location.", () => {
      expect(
        container.getAllByLabelText(/City, state, or zip code/i)[0].value
      ).toEqual("Texas");
    });
  });

  test("EPIC_EPP-44_STORY_EPP-2519 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user view the date of appointment", ({
    given,
    and,
    then,
  }) => {
    ...
    and("user views the date of appointment.", () => {
      expect(container.getAllByLabelText(/Date/i)[0]).toBeInTheDocument();
    });
  });

  test("EPIC_EPP-44_STORY_EPP-2519 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user views the purpose of visit", ({
    given,
    and,
    then,
  }) => {
    ...
    and("user views the purpose of the visit.", () => {
      expect(container.getByTestId("select-purposes-of-visit").value).toEqual(
        ""
      );
    });
  });

  test("EPIC_EPP-44_STORY_EPP-2519 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user view the insurance carrier.", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether user is able to see Schedule Appointment screen with the selected location, date, purpose of visit and insurance carrier", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user is able to see the timeslot in the Schedule Oppointments screen", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user is able to select the timeslot in the Schedule Oppointments screen", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user lands on the screen to review the appointment details", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user selects the option to change the insurance career", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user should get navigated to the screen to select an insurance career", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user able to Change Insurance", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-2519 - Verify whether the user able to review the appointment details once again", ({
    given,
    and,
    then,
  }) => {
