...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint9/EPP-7524.feature"
);

const mock = new MockAdapter(axios);

export const mockGetPatientAccountAxios = [
  {
...
defineFeature(feature, (test) => {
  ...
  function adminLandsOnAccountRecoveryPage() {
    ...
    //     {AccountRecovery.getLayout(<AccountRecovery />)}
    //   </Provider>
    // )
    container = renderWithProviders(<AccountRecovery />, store);
  }
  ...
  async function searchMoreAccountRecoveryMenu(index) {
  ...
  async function isExperianFailed() {
    const statusInactive = await waitFor(() => container.getAllByText(/Inactive/i))
    expect(statusInactive[0]).toBeInTheDocument()
  }

  async function adminViewActivateCTA() {
    await searchMoreAccountRecoveryMenu(2)
    const activateBtn = await waitFor(() => container.getAllByTestId("menu-more-activate-account"))
    expect(activateBtn[0]).toBeInTheDocument()
  }

  async function isPatientLocked() {
    const statusLocked = await waitFor(() => container.getAllByText(/Locked/i))
    expect(statusLocked[0]).toBeInTheDocument()
  }

  async function userSeePasswordResetCTA() {
    const sendPasswordResetBtn = await waitFor(() => container.getAllByTestId("menu-more-send-password-reset"))
    expect(sendPasswordResetBtn[0]).toBeInTheDocument()
  }

  async function userSeeShareUsernameCTA() {
  ...
  async function userSeeViewSecurityQuestionCTA() {
    const viewSecurityQuestionsBtn = await waitFor(() => container.getAllByTestId("menu-more-view-security-questions"))
    expect(viewSecurityQuestionsBtn[0]).toBeInTheDocument()
  }

  test('EPIC_EPP-30_STORY_EPP-7524- Verify Admin should be able to view the list of patients based on search along with details', ({ given, and, when, then }) => {
  ...
  test('EPIC_EPP-30_STORY_EPP-7524- Verify Admin should be able to view Activate CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    then('Admin should be able to view Activate CTA', () => {
      adminViewActivateCTA()
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7524- Verify Admin should be able to view only Activate CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    then('Admin should be able to view only Activate CTA', () => {
      searchMoreAccountRecoveryMenu(2)
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7524- Verify Admin should be able to view Unlock CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    then('Admin should be able to view Unlock CTA', () => {
      searchMoreAccountRecoveryMenu(0)
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7524- Verify Admin should be able to view Locked date & time', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
  ...
  test('EPIC_EPP-30_STORY_EPP-7524- Verify User should be able to view Send password reset link CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    and('User should be able to view Send password reset link CTA', () => {
      userSeePasswordResetCTA()
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7524- Verify User should be able to view Share Username CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    and('User should be able to view Share Username CTA', () => {
      userSeeShareUsernameCTA()
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7524- Verify User should be able to view ‘View security question & answers’ CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn()
    });
    ...
    and('User should be able to view ‘View security question & answers’ CTA', () => {
      userSeeViewSecurityQuestionCTA()
    });
  });
})