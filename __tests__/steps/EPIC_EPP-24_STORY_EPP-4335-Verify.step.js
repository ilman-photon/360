...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint8/EPP-4335.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify User should be able to navigated to search doctors screen", ({
    given,
    and,
    when,
    then,
  ...
  test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the heading “Find a Doctor"', ({
    given,
    and,
    when,
    then,
    ...
    and(
      'user should be able to view the heading written as “Find a Doctor"',
      () => {
        expect(container.getAllByText(/Find a Doctor/i)[1]).toBeInTheDocument();
      }
    );
  });

  test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the copy text below heading "Doctor Search"', ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the copy text below heading 'Doctor Search'",
      () => {
        expect(container.getByText(/Doctor Search/i)).toBeInTheDocument();
      }
    );
  });

  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by City", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the option to filter doctors by City",
      () => {
        expect(
  ...
  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by ECP practise name", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the option to filter doctors by ECP practise name",
      () => {
        expect(container.getByText(/practice name/i)).toBeInTheDocument();
      }
    );
  });

  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by Specialities", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the option to filter doctors by Specialities",
      () => {
        expect(container.getByText(/Specialty/i)).toBeInTheDocument();
      }
    );
  });

  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by Sub Specialities", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the option to filter doctors by Sub Specialities",
      () => {
        expect(container.getByText(/Specialty/i)).toBeInTheDocument();
      }
    );
  ...
  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to clear all filters which when clicked will clear all the filters", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user should be able to view the option to clear all filters which when clicked will clear all the filters",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-7205_STORY_EPP-4335 - Verify user by default should be able to view the list of all doctors with details", ({
    given,
    and,
    when,
    then,
    ...
    and(
      "user by default should be able to view the list of all doctors with details",
      () => {
        expect(container.getByText(/Robert Fox/i)).toBeInTheDocument();
        expect(
          container.getByText(/Chicago Eye Institute/i)
        ).toBeInTheDocument();
      }
    );
  });
