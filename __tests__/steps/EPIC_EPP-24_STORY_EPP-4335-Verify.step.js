...
defineFeature(feature, (test) => {
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify User should be able to navigated to search doctors screen', ({ given, and, when, then }) => {
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the heading “Find a Doctor"', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the copy text below heading "Doctor Search"', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by City', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by ECP practise name', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by Specialities', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
		...
		and('user should be able to view the option to filter doctors by Specialities', () => {
			expect(container.getByText(/Speciality/i)).toBeInTheDocument()
		});
	});

	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to filter doctors by Sub Specialities', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user should be able to view the option to clear all filters which when clicked will clear all the filters', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-7205_STORY_EPP-4335 - Verify user by default should be able to view the list of all doctors with details', ({ given, and, when, then }) => {
		given('user launch Patient Portal url', () => {
			defaultValidation()
		});
