...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-20_STORY_EPP-1543 - Verify User navigates to the screen to view their care team i.e. Doctors/ Optometrists', ({ given, when, then, and }) => {
    ...
    test('EPIC_EPP-20_STORY_EPP-1543 - Verify User clicks on any of the doctor/ optometrist listed there', ({ given, when, then, and }) => {
        given('User launch Patient Portal url', () => {
            defaultValidation()
        });
    ...
    test('EPIC_EPP-20_STORY_EPP-1543 - Verify User should be able to view an option to schedule an appointment with that provider', ({ given, when, then, and }) => {
        given('User launch Patient Portal url', () => {
            defaultValidation()
        });
        ...
        and('User should be able to view an option to schedule an appointment with that provider', async () => {
            container = await renderDetail()
            expect(container.getAllByTestId("schedule-btn")[1]).toBeInTheDocument();
        });
    });

    test('EPIC_EPP-14_STORY_EPP-1543-Negative Test Cases-Verify user should see the error message when the internet service is unavailable - when User clicks on any of the doctor/ optometrist listed there', ({ given, when, then, and }) => {
        given('User launch Patient Portal url', () => {
            defaultValidation()
        });
    ...
    test('EPIC_EPP-14_STORY_EPP-1543-Negative Test Cases-Verify user should see the error message when the service is unavailable - when User clicks on any of the doctor/ optometrist listed there', ({ given, when, then, and }) => {
        given('User launch Patient Portal url', () => {
            defaultValidation()
        });
