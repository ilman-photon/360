...
defineFeature(feature, (test) => {
  ...
  test('"EPIC_EPP-3_STORY_EPP-1605-Verify User should not be able to see the option to cancel an optometry appointment 4 hours before the time of appointment"', ({ given, when, and, then }) => {
    ...
    and(/^User should not be able to see the option to cancel an optometry appointment (\d+) hours before the time of appointment$/, (arg0) => {
        defaultValidation();
    });
  });
