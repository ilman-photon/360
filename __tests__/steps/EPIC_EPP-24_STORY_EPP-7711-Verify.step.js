...
defineFeature(feature, (test) => {
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the option to filter by City and Specialty(Specialty and sub specialty)', ({ given, and, when, then }) => {
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the list of all the available cities and specialties', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to select multiple cities and specialties', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the Done CTA', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to click on the Done CTA to view the results based on the filters applied', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the Reset CTA', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to click on the Reset CTA to reset all the filters selected', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the Close CTA', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to click on the Close CTA to close the popup for filter without applying any filters', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the selected filters', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view option to remove the selected filters', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711- Verify User should be able to view the list of doctors updated when the selected filter is removed', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
		...
		and('User should be able to view the Done CTA', () => {
			expect(container.getByRole("button", { name: /Done/i })).toBeInTheDocument()
		});
		...
		and('User should be able to view the Reset CTA', () => {
			...
			expect(container.getByRole("button", { name: /Reset/i })).toBeInTheDocument()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711 - Negative Test Cases-Verify user should see the error message when the internet service is unavailable - when User removes the selected filter', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
	...
	test('EPIC_EPP-24_STORY_EPP-7711 - Negative Test Cases-Verify user should see the error message when the service is unavailable - when User removes the selected filter', ({ given, and, when, then }) => {
		given('User is logged into the portal', () => {
			defaultValidation()
		});
