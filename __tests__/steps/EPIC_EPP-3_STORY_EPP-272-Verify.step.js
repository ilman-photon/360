...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-3_STORY_EPP-272 - Verify if user able to answer  security "Question1"', ({
    given,
    and,
    then,
    when,
  ...
  test('EPIC_EPP-3_STORY_EPP-272 - Verify if user able to answer  security "Question2"', ({
    given,
    and,
    then,
    when,
  ...
  test('EPIC_EPP-3_STORY_EPP-272 - Verify if user able to answer  security "Question3"', ({
    given,
    and,
    then,
    when,
  ...
  test("EPIC_EPP-3_STORY_EPP-272 - Verify if user  click submit button after answering all the security question", ({
    given,
    and,
    then,
    when,
  ...
  test("EPIC_EPP-3_STORY_EPP-272 - Verify the success message after setting up  the security question", ({
    given,
    and,
    then,
    when,
