...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-1_STORY_EPP-4929 - Verify user should be able to view Test/ Lab reports widget in the dashboard with details', ({ given, and }) => {
        ...
        and('user should be able to view Test/ Lab reports widget in the dashboard.', async () => {
            await waitFor(() => container.getByText(/Test and Lab Reports/i));
            expect(container.getByText(/Test and Lab Reports/i)).toBeInTheDocument();
        });

        and('user should be able to view widget with details', async (table) => {
            await waitFor(() => container.getByText(/Eye Exam/i));
            expect(container.getByText(/Eye Exam/i)).toBeInTheDocument();
        });
    });

    test('EPIC_EPP-1_STORY_EPP-4929 - Verify user should see the message “You do not have any test/lab reports.” when there are no test/lab reports available', ({ given, and }) => {
        given('User launch Patient Portal url', () => {
            launchURL();
        });
        ...
        and('user should see the message “You do not have any test/lab reports.” when there are no test/lab reports available', async () => {
            await waitFor(() => container.getByText(/Test and Lab Reports/i));
            expect(container.getByText(/Test and Lab Reports/i)).toBeInTheDocument();
        });
    });
