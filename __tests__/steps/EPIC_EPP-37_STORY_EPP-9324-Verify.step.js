...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify User should be navigated to change password page', ({ given, and, then }) => {
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify User updates the password and view the success message', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    	...
    	then('User should be able to view the confirmation message Are you sure to change password along with Yes and No options', () => {
            expect(container.getByText(/Are you sure to change password?/i)).toBeInTheDocument()
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify User should unmask the entered password', ({ and, then, when }) => {
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify User should Login using new Password', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify User should not copy and paste on New Password and Confirm New Password fields', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify user should see the inline error This field is required when user emptied New Password and Confirm New Password fields', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    	...
    	then('user should see the inline error This field is required', async () => {
            fireEvent.click(container.getByTestId("update-btn"))
            await waitFor (() => {
                container.getAllByText(/This field is required/i)
            })
            expect(container.getAllByText(/This field is required/i)[0]).toBeInTheDocument()
    	});
    });

    test('EPIC_EPP-37_STORY_EPP-9324- Verify user should see "Password does not meet requirements" error message', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-37_STORY_EPP-9324- Verify user should see "Password do not match" error message', ({ given, and, then, when }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
