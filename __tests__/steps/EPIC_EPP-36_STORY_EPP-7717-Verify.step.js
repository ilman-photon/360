...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user should be able to view sub menu under Profile to setup change user name', ({ given, and, when, then }) => {
    ...
    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user should be able to view "Login" screen sub menu', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async() => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user should be able to view Username & Password section along with \'Update\' Link', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async() => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user should be able navigated to Update Username screen', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async () => {
            cleanup()
            container = await renderLogin()
    	});
    	...
    	then('user  should be able to navigated  Update Username screen along with', async (table) => {
            await renderUpdateUsernamePage()
    	});
    });

    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user has provided new username and confirm new username', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async() => {
            cleanup()
            container = await renderLogin()
    	});
    	...
    	and(/^user enter new user name on (.*) field$/, (arg0) => {
            ...
            fireEvent.change(usernameField, { target: { value: "patient2@mail.com" } });
    	});
    	...
    	and('user should be able to view Cancel button', () => {
            expect(container.getByRole("button", { name: /Cancel/i })).toBeInTheDocument()
    	});
    	...
    	then(/^user should be navigated back to "(.*)" screen sub menu along with success message 'Your username was successfully updated.'$/, async(arg0) => {
            container = await renderLogin()
    	});
    });

    test('EPIC_EPP-36_STORY_EPP-7717 - Verify user should be able to receive the alert for changing the username in preferred mode of communication', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async() => {
            cleanup()
            container = await renderLogin()
    	});
    ...
    test('EPIC_EPP-36_STORY_EPP-7717 - Verify username should not be changed if No is selected during confirmation', ({ given, and, when, then }) => {
    	given('User launch Patient Portal url', async() => {
            cleanup()
            container = await renderLogin()
    	});
    	...
    	then(/^user should be navigated back to "(.*)" screen and username isn't update$/, async (arg0) => {
            await renderUpdateUsernamePage()
    	});
    });
})