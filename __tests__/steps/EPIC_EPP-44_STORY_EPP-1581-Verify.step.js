...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-44_STORY_EPP-1581 -Verify user able to view inline error message if Email or Phone Number is not entered', ({ given, when, then, and }) => {
    ...
    test('EPIC_EPP-44_STORY_EPP-1581 -Verify user able to click only mobile as preferences mode and able to get the link', ({ given, when, then, and }) => {
        given('user launch the Marketing Site url', () => {
    ...
    test('EPIC_EPP-44_STORY_EPP-1581 -Verify user able to click only email as preferences mode and able to get the link', ({ given, and, when, then }) => {
        given('user launch the Marketing Site url', () => {
    ...
    test('EPIC_EPP-44_STORY_EPP-1581 -Verify user able to click both as preferences mode and able to get the link to create password', ({ given, when, then, and }) => {
        given('user launch the Marketing Site url', () => {
