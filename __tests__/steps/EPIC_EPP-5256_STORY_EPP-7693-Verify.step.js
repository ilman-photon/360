...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint10/EPP-7693.feature",
  {
...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-5256_STORY_EPP-7693- Verify User should be able to view the list of submitted forms i.e name of each form listed', ({ given, and, when, then }) => {
  ...
  test('EPIC_EPP-5256_STORY_EPP-7693- Verify User should be able to view only the latest submitted form of those 9 forms that have been filled online', ({ given, and, when, then }) => {
    given('User is logged into the portal', () => {
      window.matchMedia = createMatchMedia("1290px");
      launchBrowser();
    });
  ...
  test('EPIC_EPP-5256_STORY_EPP-7693- Verify User should be able to view the last submitted date for each of the submitted form', ({ given, and, when, then }) => {
    given('User is logged into the portal', () => {
      window.matchMedia = createMatchMedia("1290px");
      launchBrowser();
    });
  ...
  test('EPIC_EPP-5256_STORY_EPP-7693- Verify User should be able to view the option to download each submitted form', ({ given, and, when, then }) => {
    given('User is logged into the portal', () => {
      window.matchMedia = createMatchMedia("1290px");
      launchBrowser();
    });
