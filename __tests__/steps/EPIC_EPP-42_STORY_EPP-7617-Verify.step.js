...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint9/EPP-7617.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-42_STORY_EPP-7617- Verify External user should see the health records downloaded as a pdf file in their local system/ device", ({
    given,
    and,
    when,
    then,
