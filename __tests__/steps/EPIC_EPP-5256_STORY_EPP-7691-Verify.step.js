...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint10/EPP-7691.feature",
  {
...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-5256_STORY_EPP-7691- Verify User should be able to view the option to download each form to fill them offline", ({
    given,
    and,
    when,
    then,
