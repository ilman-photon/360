...
defineFeature(feature, (test) => {
  test("EPIC_EPP-121_STORY_EPP-240-verify whether Internal Provider, Referring Provider  is able to click on the forgot password link", ({
    ...
    and(
      "Internal  Provider, Referring Provider  navigates to forgot password screen",
      () => {}
    );
    ...
    then(
      "ser should see heading A link has been sent to your registered email to reset your password.Please check",
      () => {
    ...
    and("user click 'Back to Login' button", () => {
      const backtologin = container.getByRole("button", {
        name: /backtologin/i,
      });
