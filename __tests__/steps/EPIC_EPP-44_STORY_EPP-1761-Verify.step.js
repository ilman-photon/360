...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1761-To verify whether the registered user can able to Reset the password and Appointment is synced automatically", ({
    given,
    when,
    and,
    then,
    ...
    and(
      "registered user select the Purpose of Visit, Location and Date & Time with provider.",
      () => {
        searchScreen();
      }
    );
    ...
    and(
      "registered user should see the mentioned fields Login, Create an Account and Forgot password",
      async () => {
    ...
    and("registered user should able to set the password.", async () => {
      container.rerender(<ForgotPassword isAppointment={false} />);
      expect(
        await waitFor(() => container.getByText(/resetPasswordText/i))
      ).toBeInTheDocument();
    ...
    and(
      "the registered user should see the success message Thank you for scheduling the appointment with us. We will send a confirmation Email/ Text shortly.",
      () => {
        defaultValidation();
      }
    );
    ...
    then(
      "registered user should  able to view the Appointment under Upcoming Appointments",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1761-To verify whether the Appointment Confirmation Email is delivering to registered Email based on Preferred mode of communication", ({
    given,
    when,
    and,
    then,
    ...
    then(
      "Appointment Confirmation Email should received to the registered user.",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1761-To verify whether the Appointment Confirmation Text message is delivering to registered Phone number based on Preferred mode of communication", ({
    given,
    when,
    and,
    then,
    ...
    then(
      "Appointment Confirmation Text message should received to the registered user.",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1761-To verify the Appointment confirmation Email content", ({
    given,
    when,
    and,
    then,
    ...
    then(
      "check for whether the Email content is displaying as below",
      (table) => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1761-To verify whether the registered user can able to Reset the password from the Marketting site", ({
    given,
    when,
    and,
    then,
