...
defineFeature(feature, (test) => {
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to see the name of the medical record as same as the name of the uploaded pdf file', ({ given, and, when, then }) => {
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to see the latest medical record chart that uploaded by ECP E360', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Negative Test Cases-Verify user should see the error message when the service is unavailable - When User clicks on Health Record sub menu', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Negative Test Cases-Verify user should see the error message when the internet service is unavailable - When User clicks on Health Record sub menu', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should view the message as “No Health record available now.” in the page, if there is no medical record has been uploaded by ECP for him/her', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to view the option to share the medical record with others', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to see the option to print the medical record', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should have the provision to view the medical record', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-7205_STORY_EPP-7025 - Verify User should have the provision to view the medical record', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to see the uploaded date in ‘mm/dd/yyyy’ format', ({ given, and, when, then }) => {
    given('user launch Patient Portal url', () => {
      defaultValidation()
    });
  ...
  test('EPIC_EPP-26_STORY_EPP-7025 - Verify User should be able to see the name of the medical record as same as the name of the uploaded pdf', ({ given, and, when, then }) => {
        given('user launch Patient Portal url', () => {
          defaultValidation()
        });
