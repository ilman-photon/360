...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-53_STORY_EPP-2712- Verify whether the user is able to lands on Dashboard/ Prescription screen', ({ given, when, and, then }) => {
    ...
    test('EPIC_EPP-53_STORY_EPP-2712- Verify whether the user is able to view a link', ({ given, when, and, then }) => {
        given('user Launch  the browser and enter the user portal URL', () => {
            defaultValidation()
        });
    ...
    test('EPIC_EPP-53_STORY_EPP-2712- Verify whether the user will redirect to an e-commerce site in a new tab', ({ given, when, and, then }) => {
        given('user Launch  the browser and enter the user portal URL', () => {
            defaultValidation()
        });
        ...
        and('user should be able to view a link', () => {
            expect(container.getByTestId("ecommerce-mobile-button-0")).toBeInTheDocument()
        });
