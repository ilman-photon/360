...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-23_STORY_EPP-4968 - Verify User clicks on one of the sent messages', ({ given, when, and, then }) => {
    ...
    test('EPIC_EPP-23_STORY_EPP-4968 - Verify User should be able to view the subject of the received message', ({ given, when, and, then }) => {
        given('User launch Patient Portal url', async () => {
           container = await renderLogin(container);
           await doLogin(mock, container);
        });
    ...
    test('EPIC_EPP-23_STORY_EPP-4968 - Verify User should be able to view the body of the received message', ({ given, when, and, then }) => {
        given('User launch Patient Portal url', async () => {
           container = await renderLogin(container);
           await doLogin(mock, container);
        });
    ...
    test('EPIC_EPP-23_STORY_EPP-4968 - Verify User should be able to view attachments if any present along with an option to download it', ({ given, when, and, then }) => {
        given('User launch Patient Portal url', async () => {
           container = await renderLogin(container);
           await doLogin(mock, container);
        });
    ...
    test('EPIC_EPP-23_STORY_EPP-4968 - Verify User should be able to view the date and time when message was sent', ({ given, when, and, then }) => {
        given('User launch Patient Portal url', async () => {
           container = await renderLogin(container);
           await doLogin(mock, container);
        });
