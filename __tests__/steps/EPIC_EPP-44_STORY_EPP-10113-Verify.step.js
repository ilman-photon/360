...
const feature = loadFeature(
	"./__tests__/feature/Patient Portal/Sprint10/EPP-10113.feature",
	{
...
defineFeature(feature, (test) => {
	...
	test('EPIC_EPP-44_STORY_EPP-10113- Verify User should be able to click on the \'Schedule an appointment\' CTA from Marketing site', ({ given, and }) => {
	...
	test('EPIC_EPP-44_STORY_EPP-10113- Verify User should be able to view search for location, select the date of appointment as well as purpose of visit and insurance', ({ given, when, then, and }) => {
        given('User launches the Marketing site patient portal URL', async () => {
			container = await renderLogin(container);
			await doLogin(mock, container)
	...
	test('EPIC_EPP-44_STORY_EPP-10113- Verify User should be able to select purpose of visit', ({ given, when, then, and }) => {
        given('User launches the Marketing site patient portal URL', async () => {
			container = await renderLogin(container);
			await doLogin(mock, container)
	...
	test('EPIC_EPP-44_STORY_EPP-10113- Verify User should be prompted with inline validation error message “This field is required” when the purpose of visit field is not filled', ({ given, when, then, and }) => {
        given('User launches the Marketing site patient portal URL', async () => {
			container = await renderLogin(container);
			await doLogin(mock, container)
	...
	test('EPIC_EPP-44_STORY_EPP-10113- Verify User should not be able to create/ reschedule an appointment without selecting a ‘Purpose of Visit’', ({ given, when, then, and }) => {
        given('User launches the Marketing site patient portal URL', async() => {
			container = await renderLogin(container);
			await doLogin(mock, container)
