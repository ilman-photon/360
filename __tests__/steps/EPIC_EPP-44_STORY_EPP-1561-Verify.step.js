...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify user able to search for location and select the date of appointment as well as purpose of visit and insurance.", ({
    given,
    then,
    and,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify user able to search for location and select the date of appointment as well as purpose of visit and insurance and user view the location", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user view the date of appointment", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user views the purpose of visit", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify the user is able to search for location and select the date of appointment as well as the purpose of visit and insurance and the user view the insurance carrier.", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether user is able to see Schedule Appointment screen with the selected location, date, purpose of visit and insurance carrier", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user is able to see the timeslot in the Schedule Oppointments screen", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user is able to select the timeslot in the Schedule Oppointments screen", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user lands on the screen to review the appointment details", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user lands on the screen to review the appointment details and proceeds to schedule it", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user lands on the screen to select who the appointment is for after proceed from appointment page", ({
    given,
    and,
    then,
  }) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user able to see Myself option in who the appointment is for screen", ({
    given,
    and,
    then,
  }) => {
    ...
    and(
      "user able to see Myself option in who the appointment is for screen",
      () => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1561 - Verify whether the user able to see Someone else option in who the appointment is for screen", ({
    given,
    and,
    then,
  }) => {
    ...
    and(
      "user able to see Someone else option in who the appointment is for screen",
      () => {
