...
const feature = loadFeature(
  "./__tests__/feature/Patient Portal/Sprint9/EPP-7525.feature"
);
...
defineFeature(feature, (test) => {
  ...
  async function searchSomethingAndOpenMoreMenu() {
    ...
    expect(menus[2]).toBeInTheDocument()
  ...
  async function userSeeActivateConfirmMsg() {
    const confirmationMsg = await waitFor(() => container.getByText(/Are you sure you want to activate/i))
  ...
  async function userViewSuccessActivateMsg() {
    const successMsg = await waitFor(() => container.getByText(/Account of/i))
    expect(successMsg).toBeInTheDocument()
  }

  async function userViewActivateCTA() {
  ...
  test('EPIC_EPP-30_STORY_EPP-7525- Verify User should be able to view the confirmation message “Are you sure to activate’ along with ‘Yes’ and ‘No’ options', ({ given, and, when, then }) => {
    ...
    then('User should be able to view the confirmation message “Are you sure to activate’ along with ‘Yes’ and ‘No’ options', () => {
      userSeeActivateConfirmMsg()
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7525- Verify User should be able to view the success message ‘Account of <Patient name> activated successfully’', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn();
    });
    ...
    then(/^User should be able to view the success message ‘Account of (.*) activated successfully’$/, (arg0) => {
      userViewSuccessActivateMsg()
    });
  });

  test('EPIC_EPP-30_STORY_EPP-7525- Verify The account of the respective patient should be activated', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn();
    });
  ...
  test('EPIC_EPP-30_STORY_EPP-7525- Verify The respective patient should receive the alert in preferred mode of communication', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn();
    });
  ...
  test('EPIC_EPP-30_STORY_EPP-7525- Verify The account should not be activated', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn();
    });
  ...
  test('EPIC_EPP-30_STORY_EPP-7525- Verify User should be able to view only Activate CTA', ({ given, and, when, then }) => {
    given('User has logged into the patient portal', () => {
      userIsLoggedIn();
    });
