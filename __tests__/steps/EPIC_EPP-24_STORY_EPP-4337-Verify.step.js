...
const mockApi = () => {
  ...
  mock
    .onGet(
      `/ecp/appointments/getDoctorDetails?pageSize=300&search.query=((firstName=co=Robert)OR(lastName=co=Robert)AND((providerDetails.specialization=co=Glaucoma)OR(providerDetails.classification=co=Glaucoma)))`
    )
    .reply(200, mockDoctorSearch);
