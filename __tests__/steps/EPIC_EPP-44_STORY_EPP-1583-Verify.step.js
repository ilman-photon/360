...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify user able to view inline error message if Email or Phone Number is not entered", ({
    given,
    and,
    when,
    then,
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify user able to click both as preferences mode and able to get the link to create password", ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify user able to click the link to reset the password", ({
    given,
    when,
    then,
    and,
  ...
  test('EPIC_EPP-44_STORY_EPP-1583 -Verify that user should be able to see the verbiage "Enter a password to setup your account"', ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify that user should be able to see the username is already auto-populated", ({
    given,
    when,
    then,
    and,
    ...
    then(
      "user should be able to see the username is already auto-populated",
      async () => {
        const contex = {
          query: {
            username: "smith1@photon.com",
        ...
        await waitFor(() => {
          container2.getAllByText(/Set Password/i);
        });
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify that upon successful registration, user should be notified to preferred mode(s) of communication", ({
    given,
    when,
    then,
    and,
    ...
    when(
      ...
      async () => {
        ...
        const confirmPassword =
          container2.container.querySelector("#confirmPassword");
    ...
    then(
      "User should be shown masked password along with an option to unmask it by default",
      () => {
        defaultValidation();
      }
    );
    ...
    and("User should see Create Account button", () => {
      const submitbutton = container2.getByRole("button", {
        name: /Set Password/i,
      });
    ...
    then(
      "user should get below notification message in either Email or mobile number based on preferred mode",
      (table) => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify that upon successful registration, user lands on the dashboard", ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 -Verify that User is able to view Past Appointments with an option to view the visit summary for each appointment", ({
    given,
    and,
    when,
    then,
    ...
    then(
      "user should see an option to view the visit summary for each appointment",
      () => {
        defaultValidation();
      }
    );
  ...
  test("EPIC_EPP-44_STORY_EPP-1583 - Verify user able to view enter Email or Phone Number to Sync Appointment Information", ({
    given,
    and,
    when,
    then,
