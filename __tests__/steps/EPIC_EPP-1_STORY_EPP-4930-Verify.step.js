...
const feature = loadFeature(
    "./__tests__/feature/Patient Portal/Sprint10/EPP-4930.feature"
);
const mockApi = () => {
...
defineFeature(feature, (test) => {
    ...
    test('EPIC_EPP-1_STORY_EPP-4930 - Verify user should be able to view Health Record widget in the dashboard.', ({ given, and }) => {
        ...
        and('user should be able to view Health Record widget in the dashboard.', async () => {
            await waitFor(() => container.getAllByText(/Health Records/i)[0]);
            expect(container.getAllByText(/Health Records/i)[0]).toBeInTheDocument();
        });
    });

    test('EPIC_EPP-1_STORY_EPP-4930 - Verify user should be able to view Health Record widget in the dashboard with details', ({ given, and }) => {
        given('User launch Patient Portal url', () => {
            launchURL();
        });
    ...
    test('EPIC_EPP-1_STORY_EPP-4930 - Verify User should see the message “You do not have any health record.” when there are no health records available', ({ given, and }) => {
        given('User launch Patient Portal url', () => {
            launchURL();
        });
    ...
    test('EPIC_EPP-1_STORY_EPP-4930 - Verify User should see options to doing some actions', ({ given, and }) => {
        given('User launch Patient Portal url', () => {
            launchURL();
        });
