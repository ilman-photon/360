...
const feature = loadFeature(
  "./__tests__/features/Patient Portal/Sprint2/EPP-220.feature"
);
  ...
  test("EPIC_EPP-7_STORY_EPP-220 -Verify should be able to receive reset password link  to the registered Email without answering the security questions if they are not set.", ({
    ...
    then(`user should view the page with “Password Reset” heading`, () => {
        ...
        const confirmationFormProps = {
            ...
            description: "If you did not receive the link, try to login with one-time link",
    ...
    and(`User should be able to view the message "Check {donj@yahoo.com} for an email to reset your password"`, () => {
        ...
        expect("Check donj@yahoo.com for an email to reset your password.").toEqual(title.textContent);
    });
