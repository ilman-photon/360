...
defineFeature(feature, (test) => {
  ...
  test("EPIC_EPP-19_STORY_EPP-2710 - Verify User should be able to click the option to cancel refill against a prescription", ({
    given,
    when,
    then,
    and,
    ...
    when(
      "User clicks on the option to cancel refill against a prescription",
      async () => {
        // const mockResponse = {
    ...
    then(
      "User should see the following message that the System sends out a cancellation of refill request to Provider portal",
      () => {}
    );
  });

  test("EPIC_EPP-1_STORY_EPP-2710 - Verify User should see the following message that the System sends out a cancellation of refill request to Provider portal", ({
    given,
    when,
    then,
    and,
  ...
  test("EPIC_EPP-1_STORY_EPP-2710 - Verify User should be able to see an option to request for refill when refill request has been cancelled", ({
    given,
    when,
    then,
    and,
    ...
    and(
      "User should be able to see an option to request for refill when refill request has been cancelled",
      () => {}
    );
  });

  test("EPIC_EPP-1_STORY_EPP-2710 - Verify User should be able to receive an email communication based on their registered email-id", ({
    given,
    when,
    then,
    and,
    ...
    and(
      ...
      (table) => {
        expect(container.getByText(/Active Medications/i)).toBeInTheDocument();
        expect(
          container.getAllByText(/Prescribed on:/i)[0]
        ).toBeInTheDocument();
      }
    );
    ...
    and(
      "User should be able to receive an email communication based on their registered email-id",
      () => {}
    );
  });

  test("EPIC_EPP-1_STORY_EPP-2710 - Verify User should be able to receive a text communication based on their registered phone number", ({
    given,
    when,
    then,
    and,
    ...
    and(
      "User should be able to receive a text communication based on their registered phone number",
      () => {}
    );
  });
});
