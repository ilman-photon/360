...
Feature:  As a user, I should be able to provide the Username to initiate reset password process. 
  ...
  Scenario: EPIC_EPP-7_STORY_EPP-215 - Verify user able to view “Login with Magic link” button and on clicking should send a magic link to the his email or phone number
    ...
    Scenario: Scenario: Verify user able to view “Login with Magic link” button and on clicking should send a magic link to the his email or phone number
  ...
  Scenario: EPIC_EPP-7 _STORY_EPP-215 - Verify user should see "Select an option" screen loaded within 3 seconds
    "Scenario: "EPIC_EPP-7 _STORY_EPP-25 - Verify user should see "Select an option" screen loaded less than 3 seconds"
