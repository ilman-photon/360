...
Feature: As a user, I should be able to set new password by answering security questions correctly during password reset process. 
  ...
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify User should see the entered mask password by default
    Scenario Outline: "EPIC_EPP-7_STORY_EPP-219 - Verify User should see the entered mask password by default"
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify User should receive an email to their registered email-id that the entered in the username field, regarding password reset
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 -  Verify User should unmask the entered password
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify User should receive a text to their registered Phone number  regarding password reset
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify User should Login using new Password
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify User should not copy and paste on "<New Password>" and "<Confirm New Password>" fields
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user should see the inline error "This field is required" when user emptied "<New Password>" and "<Confirm New Password>" fields
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user should see "Password does not meet requirements" error message
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user should see "page loading" within 3 seconds
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user  is not able to submit "Reset Password" when service is unavailable
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user  is not able to submit "Reset Password" when Internet connection is unavailable
  ...
  @Regression
  @Sprint2
  Scenario: EPIC_EPP-7_STORY_EPP-219 - Verify user should not see any scripts error when after user press F12 on the console
