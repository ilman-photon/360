...
Feature: Patient Portal: Settings– Change username – SMS communication
  User Story: As a patient, I should be able to receive an SMS if my preferred mode of communication is SMS or both, when my username is updated
  ...
  @Regression
  @Sprint10
  Scenario: EPIC_EPP-36_STORY_EPP-7721- Verify User should be able to view the SMS below (Actual verbiage to be provided by ECP)
    Scenario: EPIC_EPP-36_STORY_EPP-7721- Verify User should be able to view the SMS below (Actual verbiage to be provided by ECP)
    ...
    And User has logged into SMS app
    And User has set preferred mode of communication as SMS or both 
    When User has received SMS for username change  
