...
Feature: Patient Portal: Settings– Setup/update security questions – email communication
  User Story: As a patient, I should be able to receive an email if my preferred mode of communication is email or both when my security questions or answers are updated 
  ...
  @Regression
  @Sprint10
  Scenario: EPIC_EPP-38_STORY_EPP-9332- Verify User should be able to view the email below (Actual verbiage to be provided by ECP)
    Scenario: EPIC_EPP-38_STORY_EPP-9332- Verify User should be able to view the email below (Actual verbiage to be provided by ECP)
    ...
    |Email subject – EyeCare portal – security question updated |
    | Email body -  |
    | Hi <First name>, | 
