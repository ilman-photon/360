...
Feature: Patient Portal : Insurance  Information - Fill new insurance details
  ...
  @Patient_Portal
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if "New insurance button" is enabled for user
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 -  Verify if the user can see the existing insurance
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if the user can add new insurance details by clicking the " New Insurance  button"
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
    And clicks on "My profile"
  ...
  @Patient_Portal
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - verify if the user can see the error message “This field is required” for those mandatory fields which are not filled
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if the user can see the error message “Incorrect format” for those fields which are in incorrect format
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if the "Cancel " "button" is enabled for the user
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if the user can add maximum "5"new insurance details by clicking the " New Insurance  button"
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if the proper error message is displayed when the user tries to add more than 5 insurance.
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Patient_Portal
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 -    Verify if the proper error message is displayed when the user tries to add insurance documents without an internet connection
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 -    Verify if all fields are erased when the user refreshes the browser
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Patient_Portal
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 - Verify if a 503 Service unavailable message  displays when the user tries to fill "insurance details" when the server is on maintenance
    Given Launch  the Browser Enter 'XXX' URL
    And user lands on the “Patient Login” screen
    When user login with valid "<username>" and "<password>"
    Then user lands on the dashboard page
  ...
  @Regression
  @Sprint3
  Scenario: EPIC_EPP-10_STORY_EPP-949 -    Verify if the user can add new Insurance details by "mobile browser"
