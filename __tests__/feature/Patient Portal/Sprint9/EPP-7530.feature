Feature: Patient Portal: Admin – Share username email communication
  ...
  @Patient_Portal
  @Sprint9
  Scenario: EPIC_EPP-30_STORY_EPP-7530- Verify user should be able to receive an email with my ECP patient portal username if admin has selected the preferred mode of communication as email or both while sharing my username
    ...
    And user should be able to receive an email with my ECP patient portal username if admin has selected the preferred mode of communication as email or both while sharing my username
