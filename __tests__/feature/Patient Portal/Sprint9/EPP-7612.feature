...
Feature: Patient Portal : Share my Record/ Prescription/ Care plan - Enter access code to view shared health record
  ...
  Scenario: EPIC_EPP-42_STORY_EPP-4912 - Verify External user should be able to view the following fields
    EPIC_EPP-42_STORY_EPP-4912 - Verify External user should not be able to resend code for the next 30 mins
    ...
    Then external navigated to Shared Health Record screen contains below
    |Title written as Health Record shared by: xxx (dynamic)
    |"<Health record name>" field
  ...
  Scenario: EPIC_EPP-42_STORY_EPP-4912 - Verify External user should have the provision to view the health record which when clicked will open the health record in pdf format in another tab
    EPIC_EPP-42_STORY_EPP-4912 - Verify External user should have the provision to view the health record which when clicked will open the health record in pdf format in another tab
  ...
  Scenario: EPIC_EPP-42_STORY_EPP-4912 - Verify External user should be able to view the option to download the care plan document
    EPIC_EPP-42_STORY_EPP-4912 - Verify External user should be able to view the option to download the care plan document
