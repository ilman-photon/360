Feature: Patient Portal : Share my Record/ Prescription/ Care plan - Download shared health record
  ...
  @Sprint9
  Scenario: EPIC_EPP-42_STORY_EPP-7616- Verify External user should see the health records downloaded as a pdf file in their local system/ device
