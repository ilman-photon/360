...
Feature: Patient Portal : Appointments - User cannot reschedule  appointments beyond a particular time
  ...
  @Regression
  @Sprint5
  Scenario: EPIC_EPP-45_STORY_EPP-1603 - Verify user should receive an text message based on their registered phone number when user reshedulle upcoming appointment list
  ...
  @Sprint5
  Scenario: EPIC_EPP-45_STORY_EPP-1603 - Verify the user is not able to reschedule the upcoming appointment 4 hours before the time of appointment
    Scenario: EPIC_EPP-45_STORY_EPP-1603 - Verify the user is not able to reschedule the upcoming appointment 4 hours before the time of appointment within 3 seconds
