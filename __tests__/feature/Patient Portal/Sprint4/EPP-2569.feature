...
@P1
@Patient_Portal
Feature: Patient Portal : Schedule Appointment from marketing site - Appointment for 'self' - User redirects to page with different options
  User Story: As a user, I should be able to view the screen with different options to sync appointment to my account when the appointment is scheduled for myself
  ...
  User has reviewed the appointment details
  ...
  User redirects to the screen with the following options

  | Options                                                     | Reference Jira Story |
  |-------------------------------------------------------------|----------------------|
  | Login                                                       |                      |
  |-------------------------------------------------------------|----------------------|
  | Create an Account                                           |                      |
  |-------------------------------------------------------------|----------------------|
  | Forgot Password (covered when user navigates to Login page) |                      |

  And

  User should be able to continue as a guest by filling the following fields
