...
And User has selected a time slot
And User lands on the screen to review the appointment details as in https://eyecare-partners.atlassian.net/browse/EPP-1592 
WHEN User selects the option to change the purpose of visit
THEN User should be able to change the purpose of visit if already provided in https://eyecare-partners.atlassian.net/browse/EPP-2540 
Else User should be able to select a purpose of visit if not selected as in https://eyecare-partners.atlassian.net/browse/EPP-2535 
And System might have to remove the selection made for insurance carrier, location, date and time slot of the provider if the updated purpose of visit does not support them and inform the user
And User has to once again review the appointment details as in https://eyecare-partners.atlassian.net/browse/EPP-1592
  @BDDTEST-EPP-3809
  @Appointments
  @P1
  @Patient_Portal
...
Then user should allow to update the Purpose of visit.
  ...
  @Regression
  @Sprint4
  Scenario: EPIC_EPP-44_STORY_EPP-1594-Verify whether the user is able to select the Purpose of visit, if not selected in Previous page.
Given user launch the Patient portal URL		
When user clicks on the Schedule Appointment button
And user navigates to the schedule appointment screen
And user should select the location, Date of Appointment, Purpose of visit, Insurance carrier.
