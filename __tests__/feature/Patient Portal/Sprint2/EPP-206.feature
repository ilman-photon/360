@Authentication
@Patient_Portal
Feature: Patient Portal - Patient Login Screen - View
...
@Sprint2
@included
Scenario: EPIC_EPP-4_STORY_EPP-206-Verify whether the Password is getting mask when Admin typing the Password.
  Given Admin launch the 'XXX' url	
    And Admin navigates to the Patient Portal application
   When Admin lands onto “Patient Login” screen
    And Admin provides "<Email or Phone Number>" and "<password>"
   Then entered password should be masked.
