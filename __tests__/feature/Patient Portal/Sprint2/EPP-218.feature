...
Feature: Patient Portal : As a user, I should see error messages when the answers to the security questions are incorrect during password reset process. 
  ...
  @Patient_Portal
  @Sprint2
  Scenario Outline: EPIC_EPP-7_STORY_EPP-218 - Verify the error message if user enter 3 times wrong/incorrect answer the security questions via "Received link to Reset Password" mode
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
  ...
  @Regression
  @Sprint2
  Scenario Outline: EPIC_EPP-7_STORY_EPP-218 - Verify the error message if user enter wrong/incorrect answer the security questions via "Answer security questions" mode
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
  ...
  @Patient_Portal
  @Sprint2
  Scenario Outline: EPIC_EPP-7_STORY_EPP-218 - Verify the error message if user does not answer the security questions via "Login with magic link" mode
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
  ...
  @Patient_Portal
  @Sprint2
  Scenario Outline: EPIC_EPP-7_STORY_EPP-218 - Verify user should see Forgot password screen with empty field when reload the page
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
  ...
  @Patient_Portal
  @Sprint2
  Scenario Outline: EPIC_EPP-7 _STORY_EPP-218 - Verify user should not see any error after click on F12
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
  ...
  @Patient_Portal
  @Sprint2
  Scenario Outline: EPIC_EPP-7_STORY_EPP-218 - Verify user should see user should see "Password Recovery Security Questions" page loaded within 3 seconds
    Given use launch the 'XXX' url	
    And user navigates to the Patient Portal application
    When user lands onto “Patient Login” screen
    And user clicks on 'Forgot Password' link
